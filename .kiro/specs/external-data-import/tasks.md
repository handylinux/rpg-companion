...
- [-] 2. Импортировать новое оружие из _external_data/weapons.ts
...
- [ ] 4. Импортировать новую одежду из _external_data/clothing.ts
